    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex flex-col gap-4 mb-8">
        {items.map(({ article, quantity }) => (
          <div key={article.id} className="flex gap-4 bg-white p-4 rounded-2xl border border-gray-200 shadow-sm">
            ...
            <div className="flex flex-1 flex-col gap-1">
              ...
              <div className="flex items-center gap-2 mt-1">
                <button
                  onClick={() => quantity > 1 ? updateQty(article.id, quantity - 1) : remove(article.id)}
                ...
                <button
                  onClick={() => quantity < article.stock && updateQty(article.id, quantity + 1)}
            ...
            <div className="flex flex-col items-end justify-between">
              <button onClick={() => remove(article.id)} className="text-gray-400 hover:text-red-500 transition-colors">
